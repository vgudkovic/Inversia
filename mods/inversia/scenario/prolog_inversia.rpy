...
label prolog_inversia:
    ...
    #Докинуть файл play music inversion_pisk fadein 2.0
    ...
    "И как итог – ничего."
    play music inversion_Breath1 #dodel
...
label bad_end_inv:
    ...
    show achive_inversia at achievement_trans
    with dspr
    $ renpy.pause (3)
    hide achive_inversia
    return 0