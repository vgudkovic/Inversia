...
label prolog_inversia:
    ...
    "Любопытство отошло на второй план. Теперь моим сознанием правили ужас и страх{w=0.03}.{w=0.03}.{w=0.03}."
    ...
    "Куда-нибудь из этой темноты{w=0.03}.{w=0.03}.{w=0.03}."
    "Как можно дальше."
    ...
    "Не знаю, сколько я брёл вот так{w=0.03}.{w=0.03}.{w=0.03}."
    ...
    "Ещё и добавилось неприятное чувство в груди, словно меня что-то колит, усиливавшееся с каждым шагом{w=0.03}.{w=0.03}.{w=0.03}."
    ...
    th "Или даже кого-то{w=0.03}.{w=0.03}.{w=0.03}."
    ...
    "Удивительно, но я не сразу заметил девушку, стоящую у одной из кроватей.{w} С души словно камень свалился{w=0.03}.{w=0.03}.{w=0.03}."
    ...
    "На вид ей было всего лет шестнадцать-восемнадцать.. Совру, если скажу, что особой привлекательностью она не отличалась{w=0.03}.{w=0.03}.{w=0.03}." 
    ...
    "Но при всём при этом{w=0.03}.{w=0.03}.{w=0.03}."
    "Я не помню{w=0.03}.{w=0.03}.{w=0.03}."
    "Кто же, собственно, Я?"
    ...
    "Чего-чего, а такой быстрой реакции я не ожидал. А ведь я даже не единого звука не издал{w=0.03}.{w=0.03}.{w=0.03}."
    ...
    nn "Евгений{w=0.03}.{w=0.03}.{w=0.03}."
    ...
    "Фото совпадало с её внешностью. И раз уж она ничего не стала спрашивать, скорее всего, фото на моём бейдже тоже достоверно{w=0.03}.{w=0.03}.{w=0.03}."
    ...
    sa "Прости, но я без понятия{w=0.03}.{w=0.03}.{w=0.03}."
    zg "Как давно ты здесь?"
    sa "Я не считала. Может, день, а может, и больше{w=0.03}.{w=0.03}.{w=0.03}."
    "С каждой секундой, что я смотрел на лицо девушки, мне всё больше казалась её внешность знакомой."
    "Словно я видел её раньше, но никак не могу вспомнить, где{w=0.03}.{w=0.03}.{w=0.03}."
    ...
    show InversiaMOD sa front surprise pioneer normal with dissolve
    sa "Немного{w=0.03}.{w=0.03}.{w=0.03}."
    ...
    zg "Думаю, истина — это выход отсюда. А вот стол переговоров{w=0.03}.{w=0.03}.{w=0.03}."
    ...
    zg "Значит, есть что-то на нём{w=0.03}.{w=0.03}.{w=0.03}."
    ...
    sa "Это рисунок!"
    "Воскликнула Саша. А ведь точно, его только нужно собрать{w=0.03}.{w=0.03}.{w=0.03}."
    ".{w=0.1}.{w=0.1}."
...
label vibor_prolog:
    ...
    sa "Я ничего не понимаю, одни вопросы и ни одного ответа. Только эти чёртовы загадки{w=0.03}.{w=0.03}.{w=0.03}."
    ...
    sa "Решай ты{w=0.03}.{w=0.03}.{w=0.03}."
    "Ей и правда тяжело сейчас, раз она позволила выбирать незнакомцу{w=0.03}.{w=0.03}.{w=0.03}."
    "Но если мы останемся здесь, то ни черта не добьёмся{w=0.03}.{w=0.03}.{w=0.03}."
...
label prodolzhenie_inv:
    ...
    "Мы неспешно открыли дверь. Войдя в неё, мы снова оказались в тёмной комнате. {w} И стоило нам моргнуть, как{w=0.03}.{w=0.03}.{w=0.03}."
    show blink
...
label bad_end_inv:
    ...
    zg "Ну{w=0.03}.{w=0.03}.{w=0.03}. Я пошёл."
    ...
    sa "Я сгнию здесь{w=0.03}.{w=0.03}.{w=0.03}."
    "Я обернулся и удивлённо посмотрел на неё."
    
    show InversiaMOD sa front crying pioneer close with dissolve
    sa "Зарубки буду на стене делать{w=0.03}.{w=0.03}.{w=0.03}."
    sa "Ждать{w=0.03}.{w=0.03}.{w=0.03}."
    sa "Может, придёт кто{w=0.03}.{w=0.03}.{w=0.03}."

    #"“звук: женские всхлипывания”"
    play music zenskiu_plach fadein 3
    "Саша всхлипнула."
    sa "Спасёт{w=0.03}.{w=0.03}.{w=0.03}."
    zg "Саша{w=0.03}.{w=0.03}.{w=0.03}."
    ...
    "То ли оттого, что сам глубоко внутри был до чертиков напуган, то ли оттого, что в словах Саши я почувствовал{w=0.03}.{w=0.03}.{w=0.03}. наглость?"
    ...
    sa "Ты.{w=0.1}.{w=0.1}.{w} ТЫ{w=0.03}.{w=0.03}.{w=0.03}."
    ...
    sa "Справлюсь{w=0.03}.{w=0.03}.{w=0.03}.{w=1} Иди, раз уж собрался."
    ...
    show un rage pioneer with dspr
    zg "Подожди{w=0.03}.{w=0.03}.{w=0.03}."
    hide un rage pioneer with dspr
    "Только и успел промямлить я{w=0.03}.{w=0.03}.{w=0.03}."
